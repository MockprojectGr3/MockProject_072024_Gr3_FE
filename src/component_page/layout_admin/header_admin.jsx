...
const Header_Admin = () => {
    return (
        <>
            <nav class="fixed top-0 z-50 w-full bg-white border-gray-300  text-black">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start rtl:justify-end">
                            ...
                            <a href="/" class="flex  ms-2 md:me-24">
                                <img src={logo} class="h-8 me-3 w-full" alt="Logo" />
                                <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-black">Admin</span>
                            </a>
                        </div>
                        <div class="flex-1 mx-4 justify-center w-50">
                            <form class="relative">
                                <input type="text" id="search" class="block w-50 px-4 py-2 text-black border border-gray-300 rounded-lg  dark:text-black dark:placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Search..." />
                                <button type="submit" class="absolute inset-y-0 right-0 flex items-center pr-3">
                                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a7 7 0 110 14 7 7 0 010-14zm0 0l6 6"></path>
                                    </svg>
                                </button>
                            </form>
                        </div>
            ...
            <aside id="logo-sidebar" class="fixed text-black top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white  sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
                <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                    <ul class="space-y-2 font-medium">
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black  dark:hover:bg-blue-700 hover:text-white group">
